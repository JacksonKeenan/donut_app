...
function Pagination({ currentPage, totalDonuts, donutsPerPage, onPageChange}) {
    const totalPages = Math.ceil(totalDonuts / donutsPerPage)
...
Pagination.propTypes = {
    ...
    totalDonuts: PropTypes.number.isRequired,
    donutsPerPage: PropTypes.number.isRequired,
