...
function Pagination({ currentPage, totalToppings, toppingsPerPage, onPageChange}) {
    const totalPages = Math.ceil(totalToppings / toppingsPerPage)
...
Pagination.propTypes = {
    ...
    totalToppings: PropTypes.number.isRequired,
    toppingsPerPage: PropTypes.number.isRequired,
